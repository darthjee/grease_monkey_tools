(function($){
	...
	if ($css.length == 0)
	{
		...
		$('body').append($css);
		$('head').append('<link rel="stylesheet" href="/web/app/css/modules/comentarios.css" />');
	}
	var div = $('#GMS-Menu');
	...
	menu.add($.fn.menu.bolao.jsonpWatcher());
	menu.add($.fn.menu.bolao.idBringer());
	menu.add($.fn.menu.bolao.watcher());
